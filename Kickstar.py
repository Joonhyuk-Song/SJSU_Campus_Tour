...
latest_text = ""
response_text = ""  # Ensure response_text has a default value
pipeline = PDFRAGPipeline(pdf_path=r"C:\Users\joons\OneDrive\Desktop\PES_Project\venv1\Kickstar\SJSU_combined_V1.pdf")
...
def get_text():
    ...
    if not response_text:
        return jsonify({"message": "No response available yet"}), 400  # Handle case if no text has been processed
